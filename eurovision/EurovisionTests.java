...
public class EurovisionTests {
    ...
    public void testFirstBasic() {
        ...
        for (int i = 1; i <= 30; i++) {
            ...
            assertEquals("CustomerQueue testFirstBasic: First does not point the first enqueued customer", firstCustomerName, queue.first.c.name);
        }
    }
    ...
    public void testFirstAfterDequeue() {
        ...
        assertEquals("CustomerQueue testFirstAfterDequeue: First does not point the first enqueued customer", "customer " + firstCustomerIndex, queue.first.c.name);
        queue.dequeue();
        firstCustomerIndex++;
        assertEquals("CustomerQueue testFirstAfterDequeue: First was not updated properly after dequeue", "customer " + firstCustomerIndex, queue.first.c.name);
        queue.dequeue();
        firstCustomerIndex++;
        assertEquals("CustomerQueue testFirstAfterDequeue: First was not updated properly after dequeue", "customer " + firstCustomerIndex, queue.first.c.name);
    }
    ...
    public void testLastBasic() {
        ...
        for (int i = 1; i <= 30; i++) {
            ...
            assertEquals("CustomerQueue testLastBasic: Last does not point the last enqueued customer", customerName, queue.last.c.name);
        }
    }
    ...
    public void testLastAfterDequeue() {
        ...
        queue.dequeue();
        assertEquals("CustomerQueue testLastAfterDequeue: Last should not change after dequeue", customerName, queue.last.c.name);
    }
    ...
    public void testNextPrevBasic() {
        ...
        assertEquals("CustomerQueue testNextPrevBasic: next/prev of CustomerElement were not set correctly (2)", true, equalCustomers(queue.first.next.next.c, c));
        ...
        assertEquals("CustomerQueue testNextPrevBasic: next/prev of CustomerElement were not set correctly (4)", true, equalCustomers(queue.first.next.prev.c, a));
    }
    ...
    public void testAddthreeCustomers() {
        ...
        assertEquals("EuroVisionQueue: testAddthreeCustomers: The customer was not added to the queue correctly- last"
                , true, equalCustomers(q.q.last.c, c));
    ...
    public void testServePriorityCustomerLast() {
        ...
        assertEquals("EuroVisionQueue: testServePriorityCustomerLast: The customer was not removed from the queue correctly- heapIndex"
                , true, equalCustomers(q.heap.heap[q.q.peek().heapIndex].c, a));
        assertEquals("EuroVisionQueue: testServePriorityCustomerLast: The customer was not removed from the queue correctly- heapIndex"
                , true, equalCustomers(q.heap.heap[q.q.last.heapIndex].c, b));
    }
    ...
    public void testNextPrevRemovingMiddleNode() {
        ...
        assertEquals("EuroVisionQueue testNextPrevBasic: next/prev of CustomerElement were not set correctly (2)", true, equalCustomers(queue.q.first.next.c, c));
        ...
        assertEquals("EuroVisionQueue testNextPrevBasic: next/prev of CustomerElement were not set correctly (4)", true, equalCustomers(queue.q.first.next.prev.c, a));
        assertEquals("EuroVisionQueue testNextPrevBasic: next/prev of CustomerElement were not set correctly (5)", true, equalCustomers(queue.q.last.prev.c, a));
